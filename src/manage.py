...
if __name__ == "__main__":
    ...
    os.environ.setdefault("DJANGO_SETTINGS_MODULE", "HomeAutomation.settings.production")
    os.environ.__setitem__("DJANGO_SETTINGS_MODULE", "HomeAutomation.settings.production")

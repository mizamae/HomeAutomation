# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2018-01-31 09:49
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='MasterGPIOs',
            fields=[
                ('Pin', models.PositiveSmallIntegerField(primary_key=True, serialize=False, unique=True)),
                ('Label', models.CharField(max_length=50, unique=True)),
                ('Direction', models.PositiveSmallIntegerField(choices=[(0, 'Output'), (1, 'Input'), (2, 'Sensor')])),
                ('Default', models.PositiveSmallIntegerField(choices=[(0, 'LOW'), (1, 'HIGH')], default=0)),
                ('Value', models.PositiveSmallIntegerField(choices=[(0, 'LOW'), (1, 'HIGH')], default=0)),
            ],
            options={

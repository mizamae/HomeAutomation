...
#     SCRIPT TO INITIALIZE THE DB WITH DATA FROM BEGINING OF THE YEAR
    ...
    #instance.getSingleDay(date=datetime.datetime(year=2018,month=10,day=15),datagramId = 'dailyconsumption')
    instance.initializeDB(fromdate=datetime.datetime(year=2018,month=10,day=15),datagramId = 'dailyconsumption')
